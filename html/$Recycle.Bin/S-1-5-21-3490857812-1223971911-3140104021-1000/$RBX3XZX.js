var CHANGED=false,PREGOODS=[],DSFRMS,IDX=-2,ITEMIDX=-2,delConfirmMsg="建议您先将数据导出后再删除字段！\n删除将导致已提交的数据和报表中此字段对应的值被清空，且不可恢复。确认删除吗？",htmlEditor,descEditor,secdescEditor,DEFFLD=
{
  ...
  {
    html:'<label class="desc"><span class="req hide"> *</span></label><div class="content textcontent"><input type="text" disabled="disabled" maxlength="255" class="input" /><i class="iconfont qrinput hide">&#xe67d;</i></div>',json:'({LBL:"单行文本",TYP:"text",FLDSZ:"m",REQD:"0",UNIQ:"0",SCU:"pub"})',holder:'<li class="field prefocus" style="height:71px;width:97%"></li>'
  }
  ,number:
  {
